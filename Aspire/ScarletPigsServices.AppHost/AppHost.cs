...
var HAVOC_SERVER_FTP_HOST = builder.AddParameterFromConfiguration("HAVOC_SERVER_FTP_HOST", "HAVOC_SERVER_FTP_HOST", false).WithDescription("Hostname for the Havoc FTP server used by the website mission upload tool.");
var HAVOC_SERVER_FTP_PORT = builder.AddParameterFromConfiguration("HAVOC_SERVER_FTP_PORT", "HAVOC_SERVER_FTP_PORT", false).WithDescription("Port for the Havoc FTP server used by the website mission upload tool.");
var HAVOC_FTP_USER = builder.AddParameterFromConfiguration("HAVOC_FTP_USER", "HAVOC_FTP_USER", true).WithDescription("Username for the Havoc FTP server used by the website mission upload tool.");
var HAVOC_FTP_PASSWORD = builder.AddParameterFromConfiguration("HAVOC_FTP_PASSWORD", "HAVOC_FTP_PASSWORD", true).WithDescription("Password for the Havoc FTP server used by the website mission upload tool.");
var HAVOC_SERVER_FTP_ROOT = builder.AddParameterFromConfiguration("HAVOC_SERVER_FTP_ROOT", "HAVOC_SERVER_FTP_ROOT", false).WithDescription("Root path used when listing and uploading missions through the website FTP integration.");
var HAVOC_HEADLESS_FTP_HOST = builder.AddParameterFromConfiguration("HAVOC_HEADLESS_FTP_HOST", "HAVOC_HEADLESS_FTP_HOST", false).WithDescription("Optional hostname for the headless FTP server used by the website command-line generator parity checks.");
var HAVOC_HEADLESS_FTP_PORT = builder.AddParameterFromConfiguration("HAVOC_HEADLESS_FTP_PORT", "HAVOC_HEADLESS_FTP_PORT", false).WithDescription("Optional port for the headless FTP server used by the website command-line generator parity checks.");
var HAVOC_HEADLESS_FTP_USER = builder.AddParameterFromConfiguration("HAVOC_HEADLESS_FTP_USER", "HAVOC_HEADLESS_FTP_USER", false).WithDescription("Optional username override for the headless FTP server used by the website command-line generator parity checks.");
var HAVOC_HEADLESS_FTP_PASSWORD = builder.AddParameterFromConfiguration("HAVOC_HEADLESS_FTP_PASSWORD", "HAVOC_HEADLESS_FTP_PASSWORD", false).WithDescription("Optional password override for the headless FTP server used by the website command-line generator parity checks.");
var HAVOC_HEADLESS_FTP_ROOT = builder.AddParameterFromConfiguration("HAVOC_HEADLESS_FTP_ROOT", "HAVOC_HEADLESS_FTP_ROOT", false).WithDescription("Optional root path used when checking headless FTP mod folders for website command-line parity.");
...
builder.AddProject<Projects.ScarletPigsServices_Website>(ServiceRefs.WEBSITE)
    ...
    .WithEnvironment(HAVOC_FTP_PASSWORD.Resource.Name, HAVOC_FTP_PASSWORD)
    .WithEnvironment(HAVOC_SERVER_FTP_ROOT.Resource.Name, HAVOC_SERVER_FTP_ROOT)
    .WithEnvironment(HAVOC_HEADLESS_FTP_HOST.Resource.Name, HAVOC_HEADLESS_FTP_HOST)
    .WithEnvironment(HAVOC_HEADLESS_FTP_PORT.Resource.Name, HAVOC_HEADLESS_FTP_PORT)
